...
#define MAX 100 // menetapkan nilai konstanta MAX = 5 (ukuran antrian)
using namespace std;
...
int main()
{
    ...
    do
    {
        ...
        switch (pil)
        { // switch case untuk mengakses fungsi yang diinginkan
        case 1:
            // Nama : Fatkhurrohman Purnomo
            // NIM : 21102125

            data = rand() % 100 + 1; // membuat random data antrian
